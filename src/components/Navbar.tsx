...
function Navbar() {
    ...
    return (
        <div className="fixed navbar bg-slate-900 flex w-full justify-between px-4 mb-4 overflow-x-hidden">
            ...
            <div className=' w-full max-w-xl justify-evenly hidden sm:flex '>
                ...
                <a className=' text-slate-200 p-2 border-b hover:border-slate-200 border-slate-900 transition-all  '>Nuestro Blog</a>
            </div>

            <div className=' w-full max-w-xl justify-evenly flex sm:hidden '>
                <a className=' text-slate-200 p-2 border-b hover:border-slate-200 border-slate-900 transition-all  ' onClick={() => setMobileMenu(!mobileMenu)}>Menu</a>
            </div>
