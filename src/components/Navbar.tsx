        ...
        <div className=''>
            <div className="fixed navbar z-10 bg-slate-900/75 backdrop-blur-sm flex w-full justify-between px-4 mb-4 overflow-x-hidden">
                ...
                <div className=' w-full max-w-xl justify-evenly hidden sm:flex '>
                    <a className=' text-slate-200 p-2 border-b hover:border-slate-200 border-slate-900/75 transition-all' href='/About'>Sobre Nosotros</a>
                    <a className=' text-slate-200 p-2 border-b hover:border-slate-200 border-slate-900/75 transition-all' href='/Products'>Nuestros Productos</a>
                    <a className=' text-slate-200 p-2 border-b hover:border-slate-200 border-slate-900/75 transition-all' href='/Blog'>Nuestro Blog</a>
                </div>
