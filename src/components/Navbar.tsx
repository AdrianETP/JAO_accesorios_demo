        ...
        <div className=''>
            <div className="fixed navbar z-10 bg-slate-900/75 backdrop-blur-sm flex w-full justify-between px-4 mb-4 overflow-x-hidden">
                ...
                {user.isSignedIn ?
                    ...
                    :
                    <button className='rounded-full bg-gray-600 hover:bg-gray-700 transition-all duration-300  w-10 h-10 flex items-center justify-center border-2 border-slate-700 hover:border-slate-300' onClick={() => gotoLogin()}>
                        <AiOutlineUser className='text-slate-300' size={24} />
                    </button>
